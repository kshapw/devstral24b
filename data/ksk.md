# Karmika Seva Kendra (KSK) Knowledge Base
...
Karmika Seva Kendra (KSK) is an initiative of the Karnataka Building & Other Construction Workers Welfare Board (KBOCWWB). It provides construction workers and their families with access to registration, welfare schemes, claim assistance, and grievance support.

## Services Available

* Worker registration and ID card assistance
* Renewal and record updates
* Scheme application support
* Claim submission and tracking
* Guidance on worker rights
* Grievance support

## Mobile KSK (Sanchari Karmika Seva Kendra)

Mobile units travel to construction sites and rural areas to provide doorstep services including registration, scheme applications, and assistance.
...
A: It is a service center that helps construction workers register and apply for welfare schemes.

Q: Who can use the schemes?
...
A: Yes, most schemes are available only for registered workers.

Q: What is the 90 days work certificate?
A: Proof that the worker has worked at least 90 days. Required for many schemes, registration and renewal.

Q: Can nominee apply?
A: Yes, for funeral and accident assistance schemes where nominee is eligible and verified.

Q: What happens if documents are incorrect?
A: The application may be rejected or returned for correction.
...
* Beneficiary should not have availed similar benefit under Rule-47 (if applicable)
...
## Scheme: Continuation of Disability Pension

### Overview

Continuation of existing disability pension.

### Eligibility

* Previously sanctioned pension
* Age below 60

### Requirement

Annual Living Certificate submission.
...
## Scheme: Continuation of Pension

### Overview

This scheme allows registered construction workers who are already receiving pension to continue receiving it after retirement, subject to annual verification.

### Benefit

* **Maximum ₹3,000 per month.**
* The beneficiary cannot receive any other government pension scheme simultaneously.
...
* Applications are accepted **only once a year**, during the month of **December**.
* If the application is missed, the worker must wait until the next year.
...
* Pension continuation requires annual update.
* Maximum pension: ₹3,000 per month.

### FAQs

Q: Who can apply for Continuation of Pension?
A: Registered construction workers who are already receiving pension and wish to continue receiving it after retirement.

Q: What is the maximum pension amount under this scheme?
A: The pension amount is up to ₹3,000 per month.
...
Q: What happens if I miss the December application period?
A: You will need to wait until the next December to apply.

Q: Will the pension stop if I do not submit the Living Certificate?
A: Yes, failure to submit the annual Living Certificate may result in suspension of pension.

Q: Can I receive this pension along with another government pension?
A: No, beneficiaries cannot receive similar benefits under other government pension schemes.

Q: What does “no overlap with other schemes” mean?
A: It means the beneficiary must not be receiving another government pension at the same time.
...
Q: What happens after submission?
A: The Board verifies the documents and continues the pension if eligibility conditions are met.

Q: Can a family member submit the Living Certificate on behalf of the pensioner?
A: Yes, if authorized and supported with required documents, submission can be done through KSK.

Q: Will the pension increase every year?
A: No, the pension amount remains as sanctioned and will not exceed ₹3,000 per month.

Q: Is this scheme available for workers below 60 years?
A: No, this scheme is applicable only after the worker becomes eligible for pension at 60 years.
...
# Common User Questions (High-Frequency)

Q: Which schemes require 90 days work certificate?
A: Most schemes including medical, accident, pension, and assistance schemes.

Q: How do I check application status?
A: Through the portal or by visiting KSK.

Q: Where can I get help filling the application?
A: At KSK centers or Mobile KSK units.

Q: Are all schemes available for dependents?
A: Only schemes that explicitly allow dependents.

---

# Migration from Seva Sindhu to KSK (Important)

## Overview

Construction workers who were previously registered through Seva Sindhu / E-Karmika must transfer their records to the new Karmika Seva Kendra (KSK) system.

## Time Limit

* The transfer must be completed within **one year** from the worker’s registration validity expiry date.
* If the transfer is not done within this period, the worker may need to apply as a new registration.

## How to Transfer

1. Select “Already Existing Seva Sindhu Construction Worker / E-Karmika Construction Worker”.
2. Enter details exactly as shown on the Labour Card:
    * **Registration Number**
    * **Reference Number**
    * Do not modify the format.
    * Copy-paste is recommended to avoid errors.
3. Click **Verify**.

## Accepted Registration Number Formats

The number must match the Labour Card exactly, including letters, numbers, spaces, slashes, and symbols. Examples of valid formats:

* `Lo-Koppal/KOP/RGN.721250/2021-22`
* `Lo-1-Tarikere/CHI/RGN.15633/2022-23`
* `Lo_Mysore/MYS/CR/718/2013-14`
* `KUDLIGI/BRY/CMW/276/2015-16`
* `CR-3497/2009-10`
* `CR-2447/14-15`
* `KB016S230561878`
...
Enter the Reference Number exactly as printed on the Labour Card.

* Example: `LD007S200847322`
